...
<head>
    ...
    <title>@yield('title', 'Aplikasi Praktik Dokter') - Klinik</title>
            ...
            <aside class="w-64 bg-emerald-800 text-white flex-shrink-0 hidden md:flex md:flex-col">
                <div class="px-6 py-5 border-b border-emerald-700">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-lg font-bold text-white">Klinik Sehat</h1>
                ...
                <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                    @php
                        ...
                        $roleMenus = [
                            'admin' => ['Dashboard', 'Pendaftaran', 'Antrean', 'Pemeriksaan', 'Pembayaran', 'Apotek', 'Obat', 'Rekam Medis', 'Laporan', 'Jasa/Tindakan', 'Profil Dokter', 'Pengguna'],
                    ...
                    @foreach($menuItems as $label => $item)
                        ...
                        <a href="{{ route($item['route']) }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs($item['route']) ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-900/20' : 'text-emerald-100 hover:bg-emerald-700 hover:text-white' }}">
                ...
                <div class="px-3 py-4 border-t border-emerald-700">
                    <div class="flex items-center gap-3 px-3 py-2">
                        <div class="w-9 h-9 bg-emerald-600 rounded-full flex items-center justify-center text-white font-semibold text-sm uppercase">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="mt-1">
                        @csrf
                        <button type="submit" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-emerald-100 hover:bg-emerald-700 hover:text-white transition-all duration-200">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <header class="bg-white border-b border-gray-200 shadow-sm md:hidden">
                    <div class="flex items-center justify-between px-4 py-3">
                        ...
                        <h1 class="text-lg font-semibold text-gray-800">Klinik Sehat</h1>
                        <div class="w-6"></div>
                    </div>
                </header>
